...
Route::group(['middleware' => ['auth', 'active','belongsToCompany']], function () {
	...
	Route::post('category/category-data', 'CategoryController@categoryData')->name("category.data");
	...
	Route::get('report/profit_loss', 'ReportController@profitLoss')->name('report.profitLossLang'); // Added
	...
	Route::get('report/payment_report_by_date', 'ReportController@paymentReportByDate')->name('report.paymentByDateLang'); // Added

	Route::post('report/warehouse_report', 'ReportController@warehouseReport')->name('report.warehouse');
	Route::get('report/warehouse_report', 'ReportController@warehouseReport')->name('report.warehouseLang');//Added

	Route::post('report/user_report', 'ReportController@userReport')->name('report.user');
	Route::get('report/user_report', 'ReportController@userReport')->name('report.userLang'); // Added

	Route::post('report/customer_report', 'ReportController@customerReport')->name('report.customer');
	Route::get('report/customer_report', 'ReportController@customerReport')->name('report.customerLang');// added

	Route::post('report/supplier', 'ReportController@supplierReport')->name('report.supplier');
	Route::get('report/supplier', 'ReportController@supplierReport')->name('report.supplierLang'); // Added

	Route::post('report/due_report_by_date', 'ReportController@dueReportByDate')->name('report.dueByDate');
	Route::get('report/due_report_by_date', 'ReportController@dueReportByDate')->name('report.dueByDateLang'); // Added
	...
	Route::get('accounts/account-statement', 'AccountsController@accountStatement')->name('accounts.statementLang'); // Added
